        ...
        http
                ...
                .authorizeHttpRequests(
                        authorizeRequests -> authorizeRequests
                                ...
                                .requestMatchers("/api/v1/booking/summary").hasAuthority("SCOPE_ADMIN")
                                .requestMatchers("/api/v1/booking/summary-amounts").hasAuthority("SCOPE_ADMIN")
                                ...
                                .hasAnyAuthority("SCOPE_USER", "SCOPE_ADMIN")
                                .requestMatchers("/api/v1/notifications/{accountId}/update-notification")
                                .authenticated()
